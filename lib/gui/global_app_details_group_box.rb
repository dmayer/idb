...
module Idb
  class GlobalAppDetailsGroupBox < Qt::GroupBox
    ...
    def initialize *args
      ...
      @app_details_layout.addWidget @selected_app_label, 0, 0
      @app_details_layout.addWidget @selected_app, 0,1

      @uuid_label = Qt::Label.new  "<b>UUID:</b>"
      @uuid = Qt::Label.new  ""
      @app_details_layout.addWidget @uuid_label, 1, 0
      @app_details_layout.addWidget @uuid, 1,1
